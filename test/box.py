...
class hand(Exception):
    ...
    def hand_int(self, image, result, rst):
        ...
        self.opencv.putText(image, str(count), (rst.x.min, rst.y.max), self.opencv.FONT_ITALIC, 2, self.opencv.LINE_AA)
